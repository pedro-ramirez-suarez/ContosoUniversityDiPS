...
namespace ConUniv.Repositories
{
    ...
    public class InstructorRepository : IDisposable, IDataSource<Instructor, Guid> 
    {
        DBTableDataSourceBase<Instructor, Guid> dataSource;
        ...
        {
            this.TableName = typeof(Instructor).Name;
        ...
        public InstructorRepository(string connectionString,string tableName)
        {
            this.ConnectionString = connectionString;
        ...
        {
            dataSource = new DBTableDataSourceBase<Instructor, Guid>(this.ConnectionString, this.TableName);
        }
        ...
        public bool DeleteEntity(Instructor item)
        {
        ...
        public IEnumerable<Instructor> GetAll(object orderBy)
        {
            return this.dataSource.GetAll(orderBy: orderBy);
        }

        public IEnumerable<Instructor> GetMany(string select, string where, string orderBy)
        {
            return this.dataSource.GetMany(select: select, where: where, orderBy: orderBy);
        }

        public IEnumerable<Instructor> GetMany(object where)
        {
            return this.dataSource.GetMany(where: where);
        }

        public IEnumerable<Instructor> GetMany(object where, object orderBy)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy);
        }

        public IEnumerable<Instructor> GetMany(object where, Needletail.DataAccess.Engines.FilterType filterType, object orderBy, int? topN)
        {
            return this.dataSource.GetMany(where: where, filterType: filterType, orderBy: orderBy, topN: topN);
        }

        public IEnumerable<Instructor> GetMany(object where, object orderBy, Needletail.DataAccess.Engines.FilterType filterType, int page, int pageSize)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy, filterType: filterType, page: page, pageSize: pageSize);
        }

        public IEnumerable<Instructor> GetMany(string where, string orderBy, Dictionary<string, object> args, int page, int pageSize)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy, args: args, page: page, pageSize: pageSize);
        }

        public IEnumerable<Instructor> GetMany(string where, string orderBy, Dictionary<string, object> args, int? topN)
        {
        ...
        public Instructor GetSingle(object where)
        {
            return this.dataSource.GetSingle(where: where);
        }

        public Instructor GetSingle(object where, Needletail.DataAccess.Engines.FilterType filterType)
        {
            return this.dataSource.GetSingle(where: where, filterType: filterType);
        }

        public Instructor GetSingle(string where, Dictionary<string, object> args)
        {
            return this.dataSource.GetSingle(where: where, args: args);
        }

        public Guid Insert(Instructor newItem)
        {
