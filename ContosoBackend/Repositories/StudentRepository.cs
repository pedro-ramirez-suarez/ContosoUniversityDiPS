...
namespace ConUniv.Repositories
{
    ...
    public class StudentRepository : IDisposable, IDataSource<Student, Guid> 
    {
        DBTableDataSourceBase<Student, Guid> dataSource;
        ...
        {
            this.TableName = typeof(Student).Name;
        ...
        public StudentRepository(string connectionString,string tableName)
        {
            this.ConnectionString = connectionString;
        ...
        {
            dataSource = new DBTableDataSourceBase<Student, Guid>(this.ConnectionString, this.TableName);
        }
        ...
        public bool DeleteEntity(Student item)
        {
        ...
        public IEnumerable<Student> GetMany(string select, string where, string orderBy)
        {
            return this.dataSource.GetMany(select: select, where: where, orderBy: orderBy);
        }

        public IEnumerable<Student> GetMany(object where)
        {
            return this.dataSource.GetMany(where: where);
        }

        public IEnumerable<Student> GetMany(object where, object orderBy)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy);
        }

        public IEnumerable<Student> GetMany(object where, Needletail.DataAccess.Engines.FilterType filterType, object orderBy, int? topN)
        {
            return this.dataSource.GetMany(where: where, filterType: filterType, orderBy: orderBy, topN: topN);
        }

        public IEnumerable<Student> GetMany(object where, object orderBy, Needletail.DataAccess.Engines.FilterType filterType, int page, int pageSize)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy, filterType: filterType, page: page, pageSize: pageSize);
        }

        public IEnumerable<Student> GetMany(string where, string orderBy, Dictionary<string, object> args, int page, int pageSize)
        {
            return this.dataSource.GetMany(where: where, orderBy: orderBy, args: args, page: page, pageSize: pageSize);
        }

        public IEnumerable<Student> GetMany(string where, string orderBy, Dictionary<string, object> args, int? topN)
        {
        ...
        public Student GetSingle(object where)
        {
            return this.dataSource.GetSingle(where: where);
        }

        public Student GetSingle(object where, Needletail.DataAccess.Engines.FilterType filterType)
        {
            return this.dataSource.GetSingle(where: where, filterType: filterType);
        }

        public Student GetSingle(string where, Dictionary<string, object> args)
        {
            return this.dataSource.GetSingle(where: where, args: args);
        }

        public Guid Insert(Student newItem)
        {
